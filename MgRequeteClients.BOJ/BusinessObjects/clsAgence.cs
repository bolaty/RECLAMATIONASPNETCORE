...
namespace MgRequeteClients.BOJ.BusinessObjects
{
    public class clsAgence
    {
        ...
        public clsAgence(string SO_CODESOCIETE, string AG_CODEAGENCE, string AG_AGENCECODE, string _PY_CODEPAYS, string VL_CODEVILLE, string ZN_CODEZONE, string DY_CODEDOCUMENT,
            string AG_RAISONSOCIAL, string AG_BOITEPOSTAL, string AG_ADRESSEGEOGRAPHIQUE, string AG_TELEPHONE, string AG_FAX, string AG_EMAIL,
            string AG_NUMEROAGREMENT, string AG_REFERENCE, DateTime AG_DATECREATION, string AG_ACTIF, string OP_CODEOPERATEUR, string AG_EMAILMOTDEPASSE, string AG_NUMEROCOMPTE,
             string AG_CINETSITEID, string AG_CINETAPIKEY, string AG_CINETAPIPWD, string AG_CINETURLNOTIFICATIONZENITH, string AG_CINETURLNOTIFICATIONTONTINE,
             string AG_URLINTOUCHCASHIN, string AG_URLINTOUCHCASHOUT, string AG_TOKENTOUCHLOGIN, string AG_TOKENTOUCHPWD, string AG_RAISONSOCIALABREGEPOURSMS)
        {
