...
namespace MgRequeteClients.BOJ.BusinessObjects
{
    public class clsReqtontineepargnantjournalier
    {
        ...
        private DateTime _EJ_DATESAISIE = DateTime.Parse("01/01/1900");
        ...
        public clsReqtontineepargnantjournalier(clsReqtontineepargnantjournalier clsReqtontineepargnantjournalier)
        {
            ...
            this.TYPEOPERATION = clsReqtontineepargnantjournalier.TYPEOPERATION;
        }
